...
- [ ] **Phase 5: Foundation & GPU Engine** - God Crate decomposition, GPU physics cutover, multi-GPU wave-front dispatch, fixed-point arithmetic, 5-district HCMC network, SUMO file imports, Krauss car-following model
...
- [ ] 05-05-PLAN.md -- Multi-GPU partitioning + boundary protocol + 280K benchmark
...
| 5. Foundation & GPU Engine | 2/5 | In Progress|  | - |
