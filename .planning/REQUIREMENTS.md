...
- [x] **DET-04**: User can see camera positions and FOV coverage areas overlaid on the map
- [x] **DET-05**: System accepts speed estimation data from external CV services per camera
- [x] **DET-06**: Python and Rust client libraries connect to VELOS gRPC detection service for integration testing
...
- [x] **R3D-02**: Roads render as 3D surface polygons with lane markings
